...
5. Distribuição, no ship, depois do bump nos oito pontos (R13; obrigação constitucional registrada como NOT-APPLICABLE no plan-only):
   ...
   O segundo comando dá a versão publicada; o alvo é o patch seguinte (hoje 6.0.30 → 6.0.31). O `README.md` entra no mesmo nó de documentação pelo heading e pela frase da l.72 (FR-012).
