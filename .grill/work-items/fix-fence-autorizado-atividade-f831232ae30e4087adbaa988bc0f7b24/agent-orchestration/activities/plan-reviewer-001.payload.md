# Payload técnico — plan-reviewer-001 (REVISOR, fable/high)

Activity payload do core: activity_id=plan-reviewer-001, step=plan, context_id=ctx-146fb68d0d6e, fence=1, runtime=claude, write_files=[] (você NÃO escreve no repositório), author_activity_ids=[plan-author-001].
...
Input manifest: `W/agent-orchestration/activities/plan-reviewer-001.input.json` (24 arquivos). Leia todos por inteiro e confira os sha256.
