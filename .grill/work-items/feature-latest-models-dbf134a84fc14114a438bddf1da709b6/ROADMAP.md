...
- objetivo: workers e especialistas Codex despachados pelo GWD usam automaticamente o slug mais recente listado da família do seu tier/papel, sem edição manual a cada geração, e recusam fail-closed quando o catálogo não resolve; o par autor/revisor Claude passa a ser o alias `opus` (xhigh/high) no lugar de `fable`
