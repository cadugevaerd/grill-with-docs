...
```json
{
  "clauses": [
    ...
    {
      "evidence": [
        "sha256 da Constituição conferido no init: 789b55f46909c6861995740082199d912614bca7b23be4e0da5c73d824e94350",
        "status do init: constitution PRESERVED"
      ],
      "heading": "Governance",
      "id": "governance",
      "justification": "A Constituição foi preservada byte a byte e continua autoridade. Este work item não propõe alterá-la; nenhuma correção em escopo exige emenda constitucional.",
      "status": "PASS"
    }
  ],
