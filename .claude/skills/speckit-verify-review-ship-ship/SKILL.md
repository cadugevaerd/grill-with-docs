---
name: speckit-verify-review-ship-ship
description: Capture approved project learnings, revalidate, merge safely, clean up,
  and summarize delivery
compatibility: Requires spec-kit project structure with .specify/ directory
metadata:
  author: github-spec-kit
  source: verify-review-ship:commands/ship.md
---
...
Fingerprint: tree / work / plan, each reported separately
             (computed by `.specify/extensions/verify-review-ship/scripts/source-fingerprint.sh`; see `verify` for the contract)
```
