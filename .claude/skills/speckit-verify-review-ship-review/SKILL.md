...
Source fingerprint: tree <sha> / work <sha> / plan <sha>
                    (must match Converge and Verify; computed by .specify/extensions/verify-review-ship/scripts/source-fingerprint.sh)
